...
import com.example.sicupi.databinding.FragmentAdminCutiMelahirkanBinding;
import com.example.sicupi.databinding.FragmentAdminCutiPentingBinding;
...
public class AdminCutiPentingFragment extends Fragment {

    private FragmentAdminCutiPentingBinding binding;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        binding = FragmentAdminCutiPentingBinding.inflate(inflater, container, false);
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        getAllCuti("Cuti Alasan Penting");
        listener();
        ...
        binding.tabLayout.addOnTabSelectedListener(new TabLayout.OnTabSelectedListener() {
            ...
            public void onTabSelected(TabLayout.Tab tab) {
                if (tab.getPosition() == 0) {
                    ...
                    getAllCutiSelesai("Cuti Alasan Penting");
