...
public class AdminCutiMelahirkanFragment extends Fragment {

    private FragmentAdminCutiMelahirkanBinding binding;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        binding = FragmentAdminCutiMelahirkanBinding.inflate(inflater, container, false);
        ...
        binding.tabLayout.addOnTabSelectedListener(new TabLayout.OnTabSelectedListener() {
            ...
            public void onTabSelected(TabLayout.Tab tab) {
                if (tab.getPosition() == 0) {
                    ...
                    getAllCutiSelesai("Cuti Melahirkan");
