...
import com.example.sicupi.databinding.FragmentPegawaiHistoryCutiKurang14Binding;
...
public class PegawaiHistoryCutikurang14Fragment extends Fragment {

    private FragmentPegawaiHistoryCutiKurang14Binding binding;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        binding = FragmentPegawaiHistoryCutiKurang14Binding.inflate(inflater, container, false);
            ...
            public void onClick(View v) {
                ...
                btnSubmit.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View v) {
                        ...
                        // tidak boleh lebih dari 14 hari
                        else if (ChronoUnit.DAYS.between(tanggalMulai, tanggalSelesai) > 14) {
                            tvWaktuSelesai.setError("Maksimal cuti 14 hari");
                            showToast("error", "Maksimal cuti 14 hari");
                            tvWaktuSelesai.requestFocus();
                            return;
                        } else if (etPerihal.getText().toString().isEmpty()) {
                            etPerihal.setError("Perihal tidka boleh kosong");
                            ...
                            pegawaiService.insertCutiKurang14(map, fileLampiran).enqueue(new Callback<ResponseModel> () {
                                @Override
