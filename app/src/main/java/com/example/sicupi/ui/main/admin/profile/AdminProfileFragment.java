...
import com.example.sicupi.databinding.FragmentAdminProfileBinding;
import com.example.sicupi.databinding.FragmentPimpinanProfileBinding;
import com.example.sicupi.ui.main.auth.LoginActivity;
import com.example.sicupi.ui.main.pimpinan.profile.PimpinanEditProfileFragment;
...
public class AdminProfileFragment extends Fragment {
    ...
    private void listener() {
        binding.rvUbahProfile.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                getActivity().getSupportFragmentManager().beginTransaction().replace(R.id.frameAdmin, new AdminEditProfileFragment())
    ...
    private void updatePhoto() {
        ...
        adminService.updatePhotoProfile(map, foto).enqueue(new Callback<ResponseModel>() {
            @Override
